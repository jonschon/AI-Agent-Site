...
DEFAULT_SOURCES = [
    ...
    (
        ...
        0.9,
        {
            "poll_minutes": 30,
            "timeout_seconds": 10,
            "feed_urls": ["https://investor.nvidia.com/rss/news-releases.xml"],
        },
    ),
    (
        ...
        SourceType.news,
        0.88,
        {"poll_minutes": 30, "timeout_seconds": 10, "feed_urls": ["https://ir.amd.com/rss/news-releases.xml"]},
    ),
    (
        ...
        SourceType.news,
        0.88,
        {"poll_minutes": 30, "timeout_seconds": 10, "feed_urls": ["https://www.microsoft.com/en-us/Investor/rss.aspx"]},
    ),
    (
        "Amazon Press Center",
        "aboutamazon.com",
        SourceType.news,
        0.85,
        {"poll_minutes": 30, "timeout_seconds": 10, "feed_urls": ["https://www.aboutamazon.com/news/rss"]},
    ),
    (
        ...
        SourceType.news,
        0.88,
        {"poll_minutes": 30, "timeout_seconds": 10, "feed_urls": ["https://abc.xyz/investor/rss/news.xml"]},
    ),
    (
        "Meta Newsroom",
        "about.fb.com",
        SourceType.news,
        0.86,
        {"poll_minutes": 30, "timeout_seconds": 10, "feed_urls": ["https://about.fb.com/news/feed/"]},
    ),
    (
        "BAIR Blog",
        "bair.berkeley.edu",
